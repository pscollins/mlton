...
# Matches parallel-ml-bench mpl/config/mlton-soa.json at commit b4d8ba41a1a341b3a2390460f9f14e4babbc05ea
...
MLTON1_FLAGS="${SHARED_FLAGS} -shallow-flatten-max-iters 1 -pre-flatten-max-iters 0 -shallow-flatten-mechanism soa -shallow-flatten-policy maxWidthSameType:4"
